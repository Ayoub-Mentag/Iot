...
# kubectl apply -f /vagrant/k3s-configs/pp1.yaml
# kubectl apply -f /vagrant/k3s-configs/app2.yaml
# kubectl apply -f /vagrant/k3s-configs/app3.yaml
# kubectl apply -f /vagrant/k3s-configs/ingress.yaml
